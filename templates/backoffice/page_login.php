...
<div class="page">
    ...
    <form action="<?php echo url_generate(['route' => 'authenticate']); ?>" method="POST" class="form form-login">
        ...
        <div class="form-group flex flex-col">
            ...
            <input type="text" name="username" id="username"> <!--Name é a chave que será gerada para a super global POST-->
        </div>
        <div class="form-group flex flex-col">
            <label for="password">Senha:</label>
            <input type="password" name="password" id="password"> <!--Name é a chave que será gerada para a super global POST-->
        </div>
